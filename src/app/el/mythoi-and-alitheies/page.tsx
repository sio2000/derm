...
const myths = [
  ...
  {
    myth: 'Μύθος: Η κρυολιπόλυση έχει παρενέργειες που διαρκούν μήνες',
    truth: 'Αλήθεια: Η κρυολιπόλυση είναι μια ασφαλής, εγκεκριμένη θεραπεία. Μπορεί να υπάρξει παροδικό μούδιασμα ή ερυθρότητα που υποχωρεί σε λίγες ώρες.',
  },
  {
